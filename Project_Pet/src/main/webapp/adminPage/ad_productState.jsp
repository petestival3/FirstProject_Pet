...
<c:if test="${type==1}">
<a href="../adminPage/ad_product_stateHandleUpdate.do?utype=1&cbno=${vo.cbno }&buyc=${vo.buy_count}&type=${type}" class="btn-sm btn-info">배송중처리</a>
</c:if>

<c:if test="${type==2}">
<a href="../adminPage/ad_product_stateHandleUpdate.do?utype=2&cbno=${vo.cbno }&buyc=${vo.buy_count}&type=${type}" class="btn-sm btn-danger">결제취소 승인</a>
</c:if>

<c:if test="${type==4}">
<a href="../adminPage/ad_product_stateHandleUpdate.do?utype=3&cbno=${vo.cbno }&buyc=${vo.buy_count}&type=${type}" class="btn-sm btn-primary">배송완료처리</a>
</c:if>
